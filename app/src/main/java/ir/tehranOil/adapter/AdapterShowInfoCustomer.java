...
import ir.tehranOil.model.ModelListCustomer;

public class AdapterShowInfoCustomer extends RecyclerView.Adapter<AdapterShowInfoCustomer.ViewHolder> {
    Context context;
    LayoutInflater layoutInflater;
    List<ModelListCustomer> models;

    public AdapterShowInfoCustomer(Context context, List<ModelListCustomer> models) {
